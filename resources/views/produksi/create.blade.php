...
@section('content')
    <div class="page-header">
        ...
        <p>Tambahkan data produksi baru</p>
    </div>
    ...
    <div class="form-container">
        <form action="{{ route('produksi.store') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" id="kode_produksi" name="kode_produksi" value="{{ old('kode_produksi') }}" placeholder="Contoh: PRD006" required>
                @error('kode_produksi')
            ...
            <div class="form-group">
                ...
                <input type="text" id="jumlah" name="jumlah" value="{{ old('jumlah') }}" placeholder="Contoh: 500 unit" required>
                @error('jumlah')
                    <div style="color: red; font-size: 12px; margin-top: 5px;">{{ $message }}</div>
                @enderror
            </div>
