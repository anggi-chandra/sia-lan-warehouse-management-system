            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                ...
                <div style="display: flex; flex-direction: column; gap: 20px;">
                    <div class="form-group">
                        ...
                        <input type="text" id="transaction_code" name="transaction_code" value="{{ old('transaction_code', $transaksi->transaction_code) }}" placeholder="Contoh: PSN008" required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="admin_name" name="admin_name" value="{{ old('admin_name', $transaksi->admin_name) }}" placeholder="Nama Admin" required>
                        @error('admin_name')
                            <div style="color: red; font-size: 12px; margin-top: 5px;">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="jenis_pesanan" name="jenis_pesanan" value="{{ old('jenis_pesanan', $transaksi->jenis_pesanan) }}" placeholder="Jenis Pesanan">
                        @error('jenis_pesanan')
                            <div style="color: red; font-size: 12px; margin-top: 5px;">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="total" name="total" value="{{ old('total', $transaksi->total) }}" placeholder="Total Pesanan" step="0.01" required>
                        @error('total')
                            <div style="color: red; font-size: 12px; margin-top: 5px;">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="nama_barang" name="nama_barang" value="{{ old('nama_barang', $transaksi->nama_barang) }}" placeholder="Nama Barang">
                        @error('nama_barang')
                            <div style="color: red; font-size: 12px; margin-top: 5px;">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div style="display: flex; flex-direction: column; gap: 20px;">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" id="date" name="date" value="{{ old('date', $transaksi->date ? $transaksi->date->format('Y-m-d') : '') }}" required>
                        @error('date')
                            <div style="color: red; font-size: 12px; margin-top: 5px;">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="nominal_dp" name="nominal_dp" value="{{ old('nominal_dp', $transaksi->nominal_dp) }}" placeholder="Nominal DP" step="0.01">
                        @error('nominal_dp')
                            <div style="color: red; font-size: 12px; margin-top: 5px;">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="jumlah_pesanan" name="jumlah_pesanan" value="{{ old('jumlah_pesanan', $transaksi->jumlah_pesanan) }}" placeholder="Jumlah Pesanan">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="harga_pesanan" name="harga_pesanan" value="{{ old('harga_pesanan', $transaksi->harga_pesanan) }}" placeholder="Harga Pesanan" step="0.01">
                        @error('harga_pesanan')
                            <div style="color: red; font-size: 12px; margin-top: 5px;">{{ $message }}</div>
                        @enderror
                    </div>
