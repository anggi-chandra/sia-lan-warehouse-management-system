    ...
    <div class="max-w-7xl mx-auto">
        <div class="mb-8 flex items-center justify-between">
            <div>
                ...
                <p class="text-primary/60 font-medium mt-1">Perbarui detail transaksi dan pembayaran.</p>
            </div>
        ...
        <form action="{{ route('transaksi.update', $transaksi->id) }}" method="POST" class="relative">
            @csrf
            @method('PUT')
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                             ...
                             <div>
                                ...
                                <input type="text" id="jumlah_pesanan" name="jumlah_pesanan" value="{{ old('jumlah_pesanan', $transaksi->jumlah_pesanan) }}" placeholder="Qty (e.g 100)" class="w-full rounded-xl border border-gray-200 bg-gray-50 px-4 py-3 text-sm font-bold focus:outline-none focus:ring-2 focus:ring-secondary focus:border-transparent transition-all">
                    ...
                    <div class="sticky top-6 space-y-6">
                        ...
                        <div class="bg-primary rounded-3xl shadow-xl shadow-primary/20 p-8 text-white relative overflow-hidden">
                            ...
                            <div class="relative z-10">
                                ...
                                <input type="hidden" id="total_harga" name="total" value="{{ old('total', $transaksi->total) }}">
                            ...
                            <div class="space-y-5">
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="text" id="harga_pesanan" name="harga_pesanan" value="{{ old('harga_pesanan', number_format($transaksi->harga_pesanan, 0, ',', '.')) }}" placeholder="0" class="w-full rounded-xl border border-gray-200 bg-gray-50 pl-12 pr-4 py-3 text-lg font-bold text-primary focus:outline-none focus:ring-2 focus:ring-secondary focus:border-transparent transition-all">
                                    </div>
                                     @error('harga_pesanan')
                                        <p class="text-red-500 text-xs font-bold mt-1">{{ $message }}</p>
                                    @enderror
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <span class="absolute left-4 top-3.5 text-gray-400 font-bold">Rp</span>
                                        <input type="text" id="nominal_dp" name="nominal_dp" value="{{ old('nominal_dp', number_format($transaksi->nominal_dp, 0, ',', '.')) }}" placeholder="0" class="w-full rounded-xl border border-gray-200 bg-gray-50 pl-12 pr-4 py-3 text-sm font-bold focus:outline-none focus:ring-2 focus:ring-secondary focus:border-transparent transition-all">
                                    </div>
                                     @error('nominal_dp')
                                        <p class="text-red-500 text-xs font-bold mt-1">{{ $message }}</p>
                                    @enderror
                                    ...
                                    <div>
                                        <label class="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-2">Pelunasan</label>
                                         <select name="status_pelunasan" class="w-full rounded-xl border border-gray-200 bg-gray-50 px-3 py-3 text-sm font-bold focus:outline-none focus:ring-2 focus:ring-secondary focus:border-transparent transition-all">
                                            ...
                                            <option value="Belum Lunas" {{ old('status_pelunasan', $transaksi->status_pelunasan) == 'Belum Lunas' ? 'selected' : '' }}>Belum</option>
