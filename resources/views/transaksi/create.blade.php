...
@section('content')
    <div class="max-w-4xl mx-auto">
        ...
        <div class="bg-white rounded-3xl shadow-sm border border-primary/5 p-8 relative overflow-hidden">
            <form action="{{ route('transaksi.store') }}" method="POST" class="space-y-8 relative z-10">
                @csrf
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        ...
                        <div>
                         ...
                         <div>
                            ...
                            <input type="text" name="jumlah_pesanan" value="{{ old('jumlah_pesanan') }}" placeholder="Contoh: 100 Pcs" class="w-full rounded-xl border border-gray-200 bg-gray-50 px-4 py-3 text-sm font-bold focus:outline-none focus:ring-2 focus:ring-secondary focus:border-transparent transition-all">
                 ...
                 <div class="border-t border-gray-100 pt-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                        <div>
                            ...
                            <input type="number" name="total" value="{{ old('total') }}" placeholder="0" step="0.01" class="w-full rounded-xl border border-gray-200 bg-gray-50 px-4 py-3 text-sm font-bold focus:outline-none focus:ring-2 focus:ring-secondary focus:border-transparent transition-all" required>
                             @error('total')
                                <p class="text-red-500 text-xs font-bold mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                         ...
                         <div>
                            ...
                            <input type="number" name="harga_pesanan" value="{{ old('harga_pesanan') }}" placeholder="0" step="0.01" class="w-full rounded-xl border border-gray-200 bg-gray-50 px-4 py-3 text-sm font-bold focus:outline-none focus:ring-2 focus:ring-secondary focus:border-transparent transition-all">
                             @error('harga_pesanan')
                                <p class="text-red-500 text-xs font-bold mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input type="number" name="nominal_dp" value="{{ old('nominal_dp') }}" placeholder="0" step="0.01" class="w-full rounded-xl border border-gray-200 bg-gray-50 px-4 py-3 text-sm font-bold focus:outline-none focus:ring-2 focus:ring-secondary focus:border-transparent transition-all">
                             @error('nominal_dp')
                                <p class="text-red-500 text-xs font-bold mt-1">{{ $message }}</p>
                            @enderror
                        </div>
